...
Page({
  ...
  onLoad: function (options) {
    ...
    if (app.globalData.studentId_) {
      ...
      this.homework_statistical(this.data.studentInfoId, this.data.homeworkClassid, this.data.section, this.data.subjectName);
    } else {
  ...
  selectorQuery: function () {
    ...
    wx.createSelectorQuery().select('.container_').boundingClientRect(function (rect) {
      ...
      that.homework_statistical(that.data.studentInfoId, that.data.homeworkClassid, that.data.section, that.data.subjectName);
    }).exec();
  },
  homework_statistical: function (id, workid, section, subname) {
    var _self = this;
    Http.Get('/wechat/homework/wordAnswer', {
      studentInfoId: id,
